...
from .dfr_losses import (DFRReconstructionLoss, DFRContentInvarianceLoss,
                         DFROrthogonalityLoss, DFRDegradationRegressionLoss)
...
__all__ = [
    ...
    'DDQAuxLoss', 'DFRReconstructionLoss', 'DFRContentInvarianceLoss',
    'DFROrthogonalityLoss', 'DFRDegradationRegressionLoss',
    'PerceptualLoss', 'LPIPSLoss', 'FeatureConsistencyLoss'
]
